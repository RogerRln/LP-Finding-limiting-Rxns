...
%             pasue(eps)
    ...
    case {'gurobi5','gurobi6'}
        ...
        if isfield(LPproblem, 'vtype')
            LPproblem.vtype = LPproblem.vtype(:);
            [LPproblem.rhs,LPproblem.obj,LPproblem.sense,LPproblem.vtype] = deal(LPproblem.b,double(LPproblem.c),LPproblem.csense, LPproblem.vtype);
        end
        %basis reuse - Ronan
        if isfield(LPproblem,'basis') && ~isempty(LPproblem.basis)
